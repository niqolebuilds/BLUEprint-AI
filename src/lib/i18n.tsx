...
const EN: Dict = {
  ...
  dash_rice_view_leaderboard: 'View leaderboard →',
  dash_rice_pending_text: 'improvement items awaiting RICE triage',
  dash_rice_pending_cta: 'Review in Project Management',
  stat_rice_savings: 'RICE-tracked savings',
  stat_rice_savings_hint: 'scored projects realised',
...
const ID: Dict = {
  ...
  dash_rice_view_leaderboard: 'Lihat papan peringkat →',
  dash_rice_pending_text: 'item perbaikan menunggu triase RICE',
  dash_rice_pending_cta: 'Tinjau di Manajemen Proyek',
  stat_rice_savings: 'Penghematan terlacak RICE',
  stat_rice_savings_hint: 'proyek dinilai sudah terealisasi',
